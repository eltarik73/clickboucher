  ...
  return (
    <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
      <button
        ...
        className="px-8 py-4 bg-[#8b2500] hover:bg-[#6d1d00] text-white text-base font-semibold rounded-2xl transition-all shadow-lg shadow-[#8b2500]/20 active:scale-[0.98]"
      >
        Voir les boucheries
      </button>
      <button
