      ...
      <div className="min-h-screen bg-[#f8f6f3]">
        ...
        <main className="max-w-xl mx-auto px-5 mt-8">
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-[#999] mt-2 max-w-sm">
      ...
      <div className="min-h-screen bg-[#f8f6f3]">
        ...
        <main className="max-w-xl mx-auto px-5 mt-8">
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-[#999] mt-3 max-w-sm">
  ...
  return (
    <div className="min-h-screen bg-[#f8f6f3] pb-8">
      ...
      <main className="max-w-xl mx-auto px-5 mt-6 space-y-5">
        ...
        {/* Form card */}
        <div className="bg-white rounded-2xl border border-[#ece8e3] shadow-[0_1px_4px_rgba(0,0,0,0.03)] p-5 space-y-5">
          {/* Company name */}
          <div>
            <label className="text-sm font-semibold text-[#2a2018] mb-1.5 block">
          ...
          {shops.length > 0 && (
            <div>
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto rounded-xl border border-[#ece8e3] p-3">
                {shops.map((shop) => {
                  const checked = selectedShops.includes(shop.id);
                  return (
                    <label
                      key={shop.id}
                      className="flex items-center gap-3 p-2 rounded-lg cursor-pointer hover:bg-[#f5f0eb] transition-colors"
                    >
                      <input
                        type="checkbox"
                        checked={checked}
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-[#999]">{shop.city}</p>
                      </div>
                    </label>
                  );
                })}
  ...
  return (
    <header className="sticky top-0 z-10 bg-[#f8f6f3]/95 backdrop-blur-xl border-b border-[#ece8e3] px-5 py-4">
      <div className="max-w-xl mx-auto flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-[#2a2018]">Inscription Pro</h1>
      </div>
    </header>
  );
}
