          ...
          >
            <div className="flex gap-2.5 p-2.5 bg-white dark:bg-gray-800 rounded-2xl border border-[#ece8e3]/60 dark:border-white/[0.06] transition-all hover:shadow-md">
              <div className="relative w-[64px] h-[64px] rounded-xl overflow-hidden bg-gray-100 dark:bg-white/5 shrink-0">
                ...
                <div className="absolute top-0 left-0 px-1.5 py-0.5 text-white text-[11px] font-extrabold rounded-br-lg bg-purple-600">
                  Pack
                </div>
              </div>
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-baseline gap-1.5 mt-0.5">
                  ...
                  {p.packOldPriceCents && (
                    <span className="text-[11px] text-gray-500 dark:text-gray-400 line-through">{fmtPrice(p.packOldPriceCents)}</span>
                  )}
                  {p.packWeight && (
                    <span className="text-[11px] text-gray-500 dark:text-gray-400">{p.packWeight}</span>
                  )}
                </div>
