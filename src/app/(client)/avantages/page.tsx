  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Programme de fidélité et promotions</p>
      </div>
        ...
        <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
          ...
          {loyalty.nextTier ? (
            <div className="mb-4">
              ...
              <p className="text-xs text-gray-400 mt-1.5">{loyalty.nextTier.label}</p>
            </div>
          ) : (
            ...
            {loyalty.tiers.map((tier) => (
              ...
              >
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                  tier.reached ? "bg-green-500 text-white" : "bg-gray-200 dark:bg-white/10 text-gray-400"
                }`}>
            ...
            {loyalty.rewards.map((r) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {copiedCode === r.code ? <Check size={16} className="text-green-500" /> : <Copy size={16} className="text-gray-400" />}
                  </button>
                </div>
              );
            })}
              ...
              <div key={p.id} className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 dark:border-white/10">
                ...
                {p.code && (
                  <button
                    ...
                    className="p-2 rounded-lg bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10"
                  >
                    {copiedCode === p.code ? <Check size={16} className="text-green-500" /> : <Copy size={16} className="text-gray-400" />}
                  </button>
                )}
              </div>
            ))}
