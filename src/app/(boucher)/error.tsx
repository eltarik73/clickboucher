...
export default function BoucherError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[BoucherError]", error);
  }, [error]);
    ...
    <div className="min-h-screen bg-[#f8f6f3] dark:bg-[#0a0a0a] flex items-center justify-center px-5">
      <div className="max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
          Erreur dans l&apos;espace boucher
        </h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-3">
          Un probl&egrave;me est survenu dans votre espace de gestion. Veuillez
          r&eacute;essayer ou revenir &agrave; l&apos;accueil.
        </p>
