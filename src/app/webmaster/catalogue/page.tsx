        ...
        <div className="flex flex-col md:flex-row gap-2">
          ...
          {hasFilters && (
            <button
              ...
              className="flex items-center gap-1 px-3 py-2 text-sm rounded-xl text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition"
            >
              <X size={14} /> Effacer
            </button>
          )}
