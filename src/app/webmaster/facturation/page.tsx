        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {monthlyTrend.map((m) => {
                  ...
                  return (
                    <div key={m.month} className="flex-1 flex flex-col items-center gap-1">
                      ...
                      <span className="text-[10px] text-gray-500 dark:text-gray-400">{monthLabel(m.month)}</span>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-200 dark:border-white/[0.06] shadow-sm p-4">
              ...
              {shopRows.length === 0 ? (
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-8">Aucune donnée</p>
              ) : (
          ...
          <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-200 dark:border-white/[0.06] shadow-sm">
            ...
            <div className="hidden md:grid grid-cols-[1fr_80px_100px_100px_100px_40px] gap-2 px-4 py-2 text-[10px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-white/[0.06]">
              <span>Boutique</span>
