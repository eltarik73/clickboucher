      ...
      {loading ? (
        ...
        <>
          ...
          <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-200 dark:border-white/[0.06] shadow-sm">
            ...
            <div className="hidden md:grid grid-cols-[1fr_80px_100px_100px_100px_40px] gap-2 px-4 py-2 text-[10px] font-semibold text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-white/[0.06]">
              <span>Boutique</span>
            ...
            {sortedShops.length > 10 && (
              <button
                ...
                className="w-full py-3 text-xs text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 flex items-center justify-center gap-1 border-t border-gray-100 dark:border-white/[0.06] transition"
              >
                {showAllShops ? (
                  <>
