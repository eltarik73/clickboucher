    ...
    <div className="flex flex-col gap-4 animate-fade-up">
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-200 dark:border-white/[0.06] shadow-sm p-12 text-center">
          ...
          <p className="text-sm text-gray-400">Aucune commande trouvee</p>
        </div>
      ) : (
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-4 shrink-0">
                    ...
                    <span className="text-[10px] text-gray-400 min-w-[40px] text-right">
                ...
                {expanded && (
                  <div className="border-t border-gray-100 dark:border-white/5 px-4 py-3 space-y-3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-[11px]">
                      ...
                      {order.actualReady && (
                        <div>
                          <span className="text-gray-400 block">Pret a</span>
                          <span className="text-gray-700 dark:text-gray-300">{fmtDate(order.actualReady)}</span>
                        </div>
                      )}
                      {order.pickedUpAt && (
                        <div>
                          <span className="text-gray-400 block">Retire a</span>
                      ...
                      <div>
                        <span className="text-gray-400 block">Boutique</span>
                    ...
                    {/* Items table */}
                    <div>
                      <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Articles</span>
