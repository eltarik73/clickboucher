  ...
  return (
    <div className="flex flex-col gap-4 animate-fade-up">
      ...
      {search || statusFilter !== "all" || subFilter !== "all" ? (
        <p className="text-[11px] text-gray-400">{filtered.length} resultat{filtered.length > 1 ? "s" : ""}</p>
      ) : null}
      ...
      <div className="space-y-2.5">
            ...
            <div className="flex gap-3.5 items-start">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded-md ${STATUS_COLORS[s.status] || "bg-gray-100 text-gray-500"}`}>
                    {s.status}
                  </span>
                  {s.subscription && (
                    <>
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                ...
                <Link
                  ...
                  className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-white/5 text-gray-400 hover:bg-gray-200 dark:hover:bg-white/10 flex items-center justify-center transition-all"
        ...
        {filtered.length === 0 && (
          <p className="text-center text-sm text-gray-400 py-12">Aucune boucherie trouvee</p>
        )}
      </div>
    </div>
  );
