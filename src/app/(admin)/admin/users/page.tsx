          ...
          <button
            ...
            className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition-colors border ${
              roleFilter === r.value
                ...
                : "border-gray-200 dark:border-[#3a3530] text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:hover:border-[#4a4540]"
            }`}
          >
            {r.label}
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-[#3a3530] rounded-lg hover:bg-gray-100 dark:hover:bg-[#4a4540] transition-colors"
          ...
          <div className="md:hidden space-y-3">
            {filtered.map((user) => (
              ...
              >
                ...
                <div className="flex gap-2 pt-3 border-t border-gray-100 dark:border-[#3a3530]">
                  <button
                    onClick={() => openRoleDialog(user)}
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none px-3 pr-8 py-2.5 bg-gray-50 dark:bg-[#1a1814] border border-gray-200 dark:border-[#3a3530] rounded-lg text-sm text-gray-900 dark:text-[#f8f6f3] outline-none focus:ring-2 focus:ring-[#DC2626]/30"
                >
                  {ROLES.map((r) => (
