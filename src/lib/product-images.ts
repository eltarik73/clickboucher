...
// Images avec watermark laboucherie-halal.com (fond blanc, logos halal + BOUCHERIE)
// Les images génériques (boeuf-1..5, agneau-1..4, volaille-1..4, veau-1..2,
// grillades-1..4, preparations-1..2, abats-1) sont des photos ambiance SANS watermark.
const WATERMARKED_IMAGES = new Set([
  "/img/products/bavette-aloyau.jpg",
  "/img/products/entrecote-boeuf.jpg",
  "/img/products/faux-filet.jpg",
  "/img/products/steak-hache.jpg",
  "/img/products/viande-hachee.jpg",
  "/img/products/brochettes-boeuf-marine.jpg",
  "/img/products/brochettes-boeuf.jpg",
  "/img/products/cote-de-boeuf.jpg",
  "/img/products/basse-cote.jpg",
  "/img/products/plat-de-cotes.jpg",
  "/img/products/roti-boeuf-extra.jpg",
  "/img/products/onglet-boeuf.jpg",
  "/img/products/tournedos-boeuf.jpg",
  "/img/products/rumsteak.jpg",
  "/img/products/hampe.jpg",
  "/img/products/boeuf-marine.jpg",
  "/img/products/rond-de-gite.jpg",
  "/img/products/kefta-maison.jpg",
  "/img/products/selle-agneau.jpg",
  "/img/products/carre-agneau.jpg",
  "/img/products/cotes-agneau-filet.jpg",
  "/img/products/gigot-agneau.jpg",
  "/img/products/epaule-agneau.jpg",
  "/img/products/collier-agneau.jpg",
  "/img/products/poitrine-agneau.jpg",
  "/img/products/brochettes-agneau.jpg",
  "/img/products/poulet-blanc.jpg",
  "/img/products/cuisses-poulet.jpg",
  "/img/products/filet-poulet.jpg",
  "/img/products/pilons-poulet.jpg",
  "/img/products/poulet-fermier.jpg",
  "/img/products/poulet-marine.jpg",
  "/img/products/poulet-roti.jpg",
  "/img/products/ailes-poulet.jpg",
  "/img/products/brochettes-poulet-marine.jpg",
  "/img/products/cuisses-dinde.jpg",
  "/img/products/filet-dinde.jpg",
  "/img/products/delice-dinde.jpg",
  "/img/products/delice-poulet.jpg",
  "/img/products/merguez.jpg",
  "/img/products/chipolatas.jpg",
  "/img/products/saucisse-volaille.jpg",
  "/img/products/saucisses-agneau.jpg",
  "/img/products/saucisses-tunisiennes.jpg",
  "/img/products/roti-veau.jpg",
  "/img/products/poitrine-veau.jpg",
  "/img/products/jarret-veau.jpg",
  "/img/products/paupiettes-veau.jpg",
  "/img/products/cote-veau-lait.jpg",
  "/img/products/noix-veau.jpg",
  "/img/products/escalope-veau.jpg",
  "/img/products/carre-veau.jpg",
  "/img/products/tendrons-veau.jpg",
  "/img/products/cotes-veau.jpg",
  "/img/products/pastrami-boeuf.jpg",
  "/img/products/bacon-dinde.jpg",
  "/img/products/rosette.jpg",
  "/img/products/mortadelle.jpg",
]);

/** Returns true if the image path has a baked-in watermark */
export function hasWatermark(imgPath: string): boolean {
  return WATERMARKED_IMAGES.has(imgPath);
}
