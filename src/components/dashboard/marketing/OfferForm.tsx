          ...
          {payer === "BUTCHER" && (
            <div className="bg-white dark:bg-[#141414] rounded-2xl border-2 border-amber-200 dark:border-amber-500/30 p-5">
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {shops.map((shop) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Store className="w-4 h-4 text-gray-500 dark:text-gray-400 shrink-0" />
                ...
                {shops.length === 0 && (
                  <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-4">Chargement des boucheries...</p>
                )}
              </div>
            </div>
          )}
            ...
            <div className="grid grid-cols-2 gap-2">
              {AUDIENCES.map((a) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 shrink-0 ${selected ? "text-red-500" : "text-gray-500 dark:text-gray-400"}`} />
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1 mt-0.5">
                        ...
                        {a.desc && (
                          <span className="text-[10px] text-gray-500 dark:text-gray-400">&middot; {a.desc}</span>
                        )}
                      </div>
                    </div>
                  </button>
