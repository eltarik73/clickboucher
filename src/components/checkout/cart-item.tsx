    ...
    <div className="premium-card p-3">
      <div className="flex gap-3">
        <div className="relative w-16 h-16 rounded-xl overflow-hidden bg-muted flex-shrink-0">
          <SafeImage type="product" src={resolveProductImage({ name: item.name, imageUrl: item.imageUrl, category: item.category })} alt={item.name} width={64} height={64} className="absolute inset-0 w-full h-full object-cover" />
        </div>
